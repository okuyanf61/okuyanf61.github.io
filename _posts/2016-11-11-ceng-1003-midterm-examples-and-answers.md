...
<img class="aligncenter size-full wp-image-68" src="/assets/1.png" alt="1" width="631" height="355" />
<h3>Answer:</h3>
{% highlight python %}
2 30 5
14 28 0
...
<img class="aligncenter size-full wp-image-69" src="/assets/2.png" alt="2" width="634" height="529" />
<h3>Answer:</h3>
{% highlight python %}
...
<img class="aligncenter size-full wp-image-70" src="/assets/3.png" alt="3" width="633" height="185" />
<h3>Answer:</h3>
{% highlight python %}
5 0
10 2
...
<img class="aligncenter size-full wp-image-71" src="/assets/4.png" alt="4" width="633" height="209" />
<h3>Answer:</h3>
{% highlight python %}
XXX:A.?B.?C.?5
XXX:A.?B.?C.?6
...
<img class="aligncenter size-full wp-image-72" src="/assets/5.png" alt="5" width="634" height="328" />
<h3>Answer:</h3>
{% highlight python %}
Answer 1: 3
Answer 2: 4 10
...
<img class="aligncenter size-full wp-image-73" src="/assets/6.png" alt="6" width="619" height="143" />
<h3>Answer:</h3>
{% highlight python %}
...
<img class="aligncenter size-full wp-image-74" src="/assets/7.png" alt="7" width="635" height="273" />
<h3>Answer:</h3>
{% highlight python %}
34
37
...
<img class="aligncenter size-full wp-image-75" src="/assets/8.png" alt="8" width="619" height="424" />
<h3>Answer:</h3>
<img class="aligncenter size-full wp-image-67" src="/assets/Q8.jpg" alt="q8" width="269" height="238" />
...
<img class="aligncenter size-full wp-image-76" src="/assets/9.png" alt="9" width="616" height="504" />
<h3>Answer:</h3>
{% highlight python %}
...
<img class="aligncenter size-full wp-image-77" src="/assets/10.png" alt="10" width="612" height="318" />
<h3>Answer:</h3>
{% highlight python %}
def middle(a, b, c):
if a &gt; b &gt; c or c &gt; b &gt; a:
...
<img class="aligncenter size-full wp-image-78" src="/assets/11.png" alt="11" width="633" height="280" />
<h3>Answer:</h3>
{% highlight python %}
...
<img class="aligncenter size-full wp-image-79" src="/assets/12.png" alt="12" width="631" height="259" />
<h3>Answer:</h3>
{% highlight python %}
def fact(n):
r = 1
...
<img class="aligncenter size-full wp-image-80" src="/assets/13.png" alt="13" width="633" height="198" />
<h3>Answer:</h3>
{% highlight python %}
...
<img class="aligncenter size-full wp-image-81" src="/assets/14.png" alt="14" width="651" height="610" /> <img class="aligncenter size-full wp-image-82" src="/assets/14-2.png" alt="14-2" width="613" height="138" />
<h3>Answer:</h3>
{% highlight python %}
a = 20
b = 9
